...
const useTokenBalance = ({
	mintAddress,
	network = "devnet",
}: TokenBalanceProps): TokenBalanceResult => {
...
// Usage Component
const TokenBalanceDisplay: React.FC<TokenBalanceProps> = ({
	mintAddress,
	network,
}) => {
	const { balance, decimals, loading, error } = useTokenBalance({
		mintAddress,
		network,
	});
	...
	return (
		<div>
			...
			<p>
				Balance: {balance.toLocaleString()} ({decimals} decimals)
			</p>
		</div>
	);
};
